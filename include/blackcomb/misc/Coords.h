...
namespace std {
     ...
     */
    template <>
    struct hash<blackcomb::misc::Point3f> {
        std::size_t operator()(const blackcomb::misc::Point3f& k) const {
     ...
     */
    template <>
    struct hash<blackcomb::misc::Point3i> {
        std::size_t operator()(const blackcomb::misc::Point3i& k) const {
